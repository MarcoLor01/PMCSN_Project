...
from utility.Rvgs import random
...
def idfTruncatedNormal (m, s, lower_bound, upper_bound):
    ...
    temp = idfNormal(m, s, u)
    return temp


# # Parametri
# mean = 35
# std_dev = 5  # Deviazione standard iniziale
# lower_bound = 20
# upper_bound = 40
#
# # Genera valori
# n_values = 50000
# values = [idfTruncatedNormal(mean, std_dev, lower_bound, upper_bound) for _ in range(n_values)]
#
# # Plotta i valori
# plt.hist(values, bins=50, density=True)
# plt.title('Distribuzione Normale Troncata ' + str(std_dev))
# plt.xlabel('Valore')
